// Wallets v4 — Money Map redesign (scoped IIFE; coexists with v3-wallets.jsx)
...
// ────────────────────────────────────────────────
// PAGE 1 — Money Map (formerly WalletsV4_Accounts)
// ────────────────────────────────────────────────
function WalletsV4_Accounts() {
      ...
      <div style={{ flex: 1, overflow: 'auto', paddingBottom: 100 }}>
        ...
        <div style={{ margin: '0 16px 14px', ...w3card(2), padding: '18px 20px' }}>
          ...
          <div style={{ marginTop: 14 }}>
            ...
            <div style={{ height: 8, borderRadius: 4, background: W3.n300, overflow: 'hidden', position: 'relative', lineHeight: "1.2", fontSize: "10px" }}>
              <div style={{ width: `${Math.min(100, usedPct)}%`, background: W3.primary500, borderRadius: "34px", height: "7.99432px" }} />
...
Object.assign(window, {
  WalletsV4_Accounts, WalletsV4_Credit, WalletsV4_Goals, WalletsV4_Budget,
});
})();